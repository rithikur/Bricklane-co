            ...
            <div className="max-w-[1440px] mx-auto px-4 md:px-10">
                ...
                <div className="mb-16 md:mb-24">
                    ...
                    <div className="relative grid md:grid-cols-12 gap-6 items-end">
                        ...
                        <div className="md:col-span-7 relative h-[420px] md:h-[560px] rounded-std overflow-hidden group">
                            <img
                        ...
                        <div className="md:col-span-5 flex flex-col gap-5 h-full">
                            ...
                            {/* Accent image */}
                            <motion.div {...f(0.2)} className="h-[200px] rounded-std overflow-hidden relative group">
                                <img
                ...
                <div>
                    ...
                    <div className="flex flex-col gap-8 md:grid md:grid-cols-6 lg:grid-cols-12 md:gap-6 md:auto-rows-[minmax(180px,auto)]">
                        ...
                        <div className="bg-primary-black text-white p-10 md:p-10 rounded-std md:col-span-3 lg:col-span-4 flex flex-col justify-between group hover:shadow-2xl transition-all duration-500">
                            <div>
                                <div className="w-14 h-14 bg-white/10 rounded-std flex items-center justify-center mb-8 backdrop-blur-sm">
                                    <MapPin size={28} />
                                </div>
                        ...
                        <div className="bg-gray-100 rounded-std md:col-span-6 lg:col-span-4 relative overflow-hidden group min-h-[350px]">
                            <img
                        ...
                        <div className="bg-primary-black text-white p-10 rounded-std md:col-span-6 lg:col-span-4 relative overflow-hidden group">
