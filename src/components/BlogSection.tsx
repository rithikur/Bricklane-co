        ...
        <section className="py-20 bg-white">
            <div className="max-w-[1440px] mx-auto px-4 md:px-8">
                <div className="flex justify-between items-end mb-12">
                    <div>
                        <h2 className="text-4xl font-bold text-primary-black mb-4">Latest from Our Blog</h2>
                        <p className="text-neutral-grey text-lg max-w-xl">Insights, tips, and trends from the world of real estate and design.</p>
                    </div>
