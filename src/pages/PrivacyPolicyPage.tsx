        ...
        <div className="min-h-screen bg-white font-display text-primary-black">
            ...
            <main className="container mx-auto px-6 py-32 max-w-4xl">
                <div className="mb-20">
                    ...
                    <p className="text-xl text-neutral-grey">Your privacy is critically important to us. This policy outlines how we collect, use, and protect your personal information.</p>
                </div>
                ...
                <div className="prose prose-lg prose-neutral max-w-none">
                    ...
                    <h2 className="text-2xl font-bold mt-12 mb-6">3. Sharing of Information</h2>
                    <p className="text-neutral-grey mb-6">
                    ...
                    <h2 className="text-2xl font-bold mt-12 mb-6">5. Your Choices</h2>
                    <p className="text-neutral-grey mb-6">
                    ...
                    <h2 className="text-2xl font-bold mt-12 mb-6">6. Changes to this Policy</h2>
                    <p className="text-neutral-grey mb-6">
