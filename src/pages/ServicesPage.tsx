        ...
        <div className="min-h-screen font-display bg-white dark:bg-dark-bg transition-colors">
            ...
            <div className="pt-10 pb-20">
                <div className="max-w-[1440px] mx-auto px-4 md:px-8 mb-16">
                    <h1 className="text-5xl md:text-6xl font-bold text-primary-black dark:text-white mb-6">Our Premium Services</h1>
                ...
                <div className="max-w-[1440px] mx-auto px-4 md:px-8 mt-20 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                    <div>
                        <h2 className="text-3xl font-bold text-primary-black dark:text-white mb-4">Concierge Service</h2>
