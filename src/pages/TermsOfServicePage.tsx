        ...
        <div className="min-h-screen bg-white dark:bg-dark-bg font-display text-primary-black dark:text-white transition-colors">
            ...
            <main className="container mx-auto px-6 py-32 max-w-4xl">
                <div className="mb-20">
                    ...
                    <h1 className="text-5xl font-bold mb-8 dark:text-white">Terms of Service.</h1>
                    <p className="text-xl text-neutral-grey dark:text-neutral-grey/80">These terms govern your use of the Bricklane platform. By accessing our services, you agree to comply with them.</p>
                </div>

                <div className="prose prose-lg prose-neutral dark:prose-invert max-w-none">
                    <h2 className="text-2xl font-bold mt-12 mb-6 dark:text-gold">1. Acceptance of Terms</h2>
                    ...
                    <h2 className="text-2xl font-bold mt-12 mb-6 dark:text-gold">2. Use of Services</h2>
                    <p className="text-neutral-grey dark:text-neutral-grey/80 mb-6">
                    ...
                    <h2 className="text-2xl font-bold mt-12 mb-6 dark:text-gold">3. Intellectual Property Rights</h2>
                    <p className="text-neutral-grey dark:text-neutral-grey/80 mb-6">
                    ...
                    <h2 className="text-2xl font-bold mt-12 mb-6 dark:text-gold">4. User Accounts</h2>
                    <p className="text-neutral-grey dark:text-neutral-grey/80 mb-6">
                    ...
                    <h2 className="text-2xl font-bold mt-12 mb-6 dark:text-gold">5. Listings and Accuracy</h2>
                    <p className="text-neutral-grey dark:text-neutral-grey/80 mb-6">
                    ...
                    <h2 className="text-2xl font-bold mt-12 mb-6 dark:text-gold">6. Limitation of Liability</h2>
                    <p className="text-neutral-grey dark:text-neutral-grey/80 mb-6">
                    ...
                    <h2 className="text-2xl font-bold mt-12 mb-6 dark:text-gold">7. Governing Law</h2>
                    <p className="text-neutral-grey dark:text-neutral-grey/80 mb-6">
